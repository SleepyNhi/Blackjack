...
newGameButton.addEventListener('click', function(){
  ...
  //creates a new deck from function createDeck
  deck = createDeck();
  shuffleCards(deck);
...
function createDeck(){
  ...
  for (let suitIdx=0; suitIdx <suits.length ; suitIdx++){
    for (let valuesIdx=0; valuesIdx < values.length ; valuesIdx++){
      ...
      deck.push(card);
      //adds card object into array with two values called suit and value.
    }
  }
  return deck;
};
